# --------------------------------------------------------------------------------------------------------------
# 操作指定的目标的属性。
# Operate on the given target's property.
# --------------------------------------------------------------------------------------------------------------
# __aoe_target_property(target property
#   < SET          [<value> ...]
#   | APPEND       [<value> ...]
#   | REMOVE       [<value> ...]
#   | CHECK        [<value> ...]
...
function(__aoe_target_property target property)
    __aoe_property(TARGET ${property} INSTANCE ${PROJECT_NAME}-${target} ${ARGN})
endfunction()
