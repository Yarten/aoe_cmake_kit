# --------------------------------------------------------------------------------------------------------------
# 操作指定的工程属性。
# Operate on the given project property.
# --------------------------------------------------------------------------------------------------------------
# __aoe_project_property(property
#   < SET          [<value> ...]
#   | APPEND       [<value> ...]
#   | REMOVE       [<value> ...]
#   | CHECK        [<value> ...]
...
function(__aoe_project_property property)
    __aoe_property(PROJECT ${property} INSTANCE ${PROJECT_NAME} ${ARGN})
endfunction()
