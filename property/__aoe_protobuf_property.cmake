# --------------------------------------------------------------------------------------------------------------
# 操作指定的 protobuf 目标的属性。
# Operate on the given protobuf target's property.
# --------------------------------------------------------------------------------------------------------------
# __aoe_protobuf_property(target property
#   < SET          [<value> ...]
#   | APPEND       [<value> ...]
#   | REMOVE       [<value> ...]
#   | CHECK        [<value> ...]
...
# )
#
# target: 指定的 aoe protobuf 目标名称
#         The specified aoe protobuf target.
#
# property: 指定的属性。
...
function(__aoe_protobuf_property target property)
    __aoe_property(PROTOBUF ${property} INSTANCE ${PROJECT_NAME}-${target} ${ARGN})
endfunction()
